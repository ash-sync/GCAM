...
import { Ad } from "../modules/ads/ad.model";
import { Category, Gallery } from "../modules/gallery/gallery.model";
    ...
    const events = await Event.insertMany([
      {
        ...
        description:
          "Join us for a grand Eid celebration with traditional food, cultural performances, and community gathering.",
        image:
          "https://images.unsplash.com/photo-1540575467063-178f50002ef5?w=600&q=80",
        category: "Religious",
      },
      {
        ...
        description:
          "Celebrate the Bengali New Year with traditional music, dance, food, and cultural exhibitions.",
        image:
          "https://images.unsplash.com/photo-1533281214515-cf30ebfc5fd2?w=600&q=80",
        category: "Cultural",
      },
      {
        ...
        description:
          "Annual sports event featuring cricket, badminton, and soccer. All ages welcome!",
        image:
      ...
      },
      {
        ...
        description:
          "Breaking fast together. Free meals for all community members during Ramadan.",
        image:
          "https://images.unsplash.com/photo-1555939594-58d7cb561841?w=600&q=80",
        category: "Religious",
      },
      {
        ...
        description:
          "Learn Bengali language, history, and traditions. Perfect for children and adults.",
        image:
    ...
    const ads = await Ad.insertMany([
      {
        ...
        image:
          "https://images.unsplash.com/photo-1552635359-bbf239df0337?w=200&q=80",
      ...
      },
      {
        ...
        description:
          "Teaching language, history, and culture to the next generation.",
        image:
          "https://images.unsplash.com/photo-1427504494785-cdecf57b76a9?w=200&q=80",
